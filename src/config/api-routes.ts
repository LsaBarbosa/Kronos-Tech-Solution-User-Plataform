...
export const LGPD_PATHS = {
  // Note: These paths are prefixed with 'api' to match external API gateway pattern
  // External: /api/lgpd/* → Internal Spring: /lgpd/*
  REQUESTS: "api/lgpd/requests",
  EMPLOYEE_EXPORT: (employeeId: string) => `api/lgpd/employees/${employeeId}/export`,
  EMPLOYEE_ANONYMIZE: (employeeId: string) => `api/lgpd/employees/${employeeId}/anonymize`,
  ADMIN_REQUESTS: "api/lgpd/admin/requests",
  ADMIN_REQUEST_DETAILS: (requestId: string) => `api/lgpd/admin/requests/${requestId}`,
  ASSIGN_REQUEST: (requestId: string) => `api/lgpd/admin/requests/${requestId}/assign`,
  ADD_NOTE: (requestId: string) => `api/lgpd/admin/requests/${requestId}/notes`,
  COMPLETE_REQUEST: (requestId: string) => `api/lgpd/admin/requests/${requestId}/complete`,
  REJECT_REQUEST: (requestId: string) => `api/lgpd/admin/requests/${requestId}/reject`,
  TRANSITION_STATUS: (requestId: string) => `api/lgpd/admin/requests/${requestId}/transition-status`,
  ...
  INVENTORY_BY_ID: (inventoryId: string) => `api/lgpd/inventory/${inventoryId}`,
} as const;
