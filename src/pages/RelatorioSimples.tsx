...
  // Mantém o estado como string para a lógica de Radio Check
...
    // Se o valor clicado for o mesmo, o desmarcamos (se quiser permitir desmarcar tudo)
    setEmployeeActive(prev => (prev === statusValue ? "" : statusValue));
  };

  // NOVO: Função para alternar o status do registro (Lógica Radio Check)
  const handleRecordActiveChange = (statusValue) => {
    // Se o valor clicado for o mesmo, o desmarcamos
    setRecordActive(prev => (prev === statusValue ? "" : statusValue));
  };
...
                      Horário de referência para cálculo do saldo de horas.
                    </p>
                  </div>
...
                  {/* Status Funcionário - AGORA COM RADIO CHECK */}
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-foreground">
                      Status do Funcionário
                    </Label>
                    <div className="flex space-x-6"> {/* Mantido o estilo flex de radio */}
                      {/* Checkbox Ativo */}
...
                        />
                        <Label htmlFor="emp-status-active" className="text-sm cursor-pointer">
                          Ativo
                        </Label>
                      </div>
                      {/* Checkbox Inativo */}
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="emp-status-inactive"
                          checked={employeeActive === "inactive"}
                          onCheckedChange={() => handleEmployeeStatusChange("inactive")}
                          className="data-[state=checked]:bg-primary data-[state=checked]:border-primary border-primary/50"
                        />
                        <Label htmlFor="emp-status-inactive" className="text-sm cursor-pointer">
                          Inativo
                        </Label>
                      </div>
                    </div>
...
                  {/* Status Registro - AGORA COM RADIO CHECK */}
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-foreground">
                      Status do Registro
                    </Label>
...
                          onCheckedChange={() => handleRecordActiveChange("active")}
                          className="data-[state=checked]:bg-primary data-[state=checked]:border-primary border-primary/50"
                        />
                        <Label htmlFor="record-status-active" className="text-sm cursor-pointer">
                          Ativo
                        </Label>
                      </div>
                      {/* Checkbox Inativo */}
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="record-status-inactive"
                          checked={active === "inactive"}
                          onCheckedChange={() => handleRecordActiveChange("inactive")}
                          className="data-[state=checked]:bg-primary data-[state=checked]:border-primary border-primary/50"
                        />
                        <Label htmlFor="record-status-inactive" className="text-sm cursor-pointer">
                          Inativo
                        </Label>
                      </div>
                    </div>
