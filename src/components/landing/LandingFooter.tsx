...
export function LandingFooter() {
  ...
  return (
    <footer className="bg-[#06264A] relative overflow-hidden">
      {/* Top accent */}
      <div
        className="absolute top-0 left-0 right-0 h-px"
        style={{ background: "linear-gradient(90deg, transparent, #2563EB60, #22D3EE60, #16A34A60, transparent)" }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1 space-y-4">
            <img src={logoAzul} alt="Kronos" className="h-7 w-auto brightness-0 invert" />
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-[#64748B]">Sistema operacional</span>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/8 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <span
            className="text-[10px] font-semibold px-3 py-1 rounded-full border border-[#22D3EE]/20"
            style={{ color: "#22D3EE", background: "rgba(34,211,238,0.07)" }}
          >
