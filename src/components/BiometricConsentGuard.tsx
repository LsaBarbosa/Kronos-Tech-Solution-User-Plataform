...
type GuardStatus = "checking" | "accepted" | "pending" | "error";

const SCROLL_END_TOLERANCE = 8;

export const BiometricConsentGuard: React.FC<BiometricConsentGuardProps> = ({
  children,
  onCancel,
}) => {
  ...
  if (status === "checking") {
    return (
      ...
      >
        ...
        <span className="text-sm">Verificando consentimento...</span>
      </div>
    );
  }
      ...
      <AlertDialogContent className="max-h-[92vh] max-w-2xl overflow-hidden">
              ...
              <div className="flex-1">
                ...
                <AlertDialogDescription>
                  {isError
                    ...
                    : "O consentimento é necessário apenas para usar recursos biométricos."}
                </AlertDialogDescription>
              </div>
            </div>
            <Button
        ...
        {isError ? (
          ...
          <>
            <ScrollArea
              ref={scrollAreaRef}
              data-testid="biometric-consent-guard-scroll"
