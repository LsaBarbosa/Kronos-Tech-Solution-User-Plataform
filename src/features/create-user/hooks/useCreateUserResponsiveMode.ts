...
export type CreateUserResponsiveMode = "desktop" | "mobile";

const getInitialMode = (): CreateUserResponsiveMode => {
...
export const useCreateUserResponsiveMode = () => {
  const [mode, setMode] = useState<CreateUserResponsiveMode>(getInitialMode);
