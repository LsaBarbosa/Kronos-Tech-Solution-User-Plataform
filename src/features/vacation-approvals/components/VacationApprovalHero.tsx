...
import { CalendarRange, ClipboardCheck, ShieldCheck, TreePalm } from "lucide-react";
        ...
        <div className="bg-[linear-gradient(135deg,#0B1220_0%,#101A33_52%,#1E3A8A_100%)] px-5 py-5 text-white">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 space-y-3">
              <div className="flex items-center gap-2">
                <TreePalm className="h-5 w-5 text-cyan-300" />
              ...
              <div className="space-y-2">
                <h1 className="text-xl font-semibold leading-tight">
                  Mesa de aprovação gerencial de férias
                </h1>
                <p className="text-sm leading-6 text-white/78">
                  Analise solicitações, valide o período e aplique a decisão em lote.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-2">
            <div className="rounded-xl border border-white/15 bg-white/10 px-3 py-2">
              <p className="text-[10px] uppercase tracking-[0.22em] text-white/70">Aprovadas</p>
              <p className="text-lg font-semibold text-white">{approved}</p>
            </div>
            <div className="rounded-xl border border-white/15 bg-white/10 px-3 py-2">
              <p className="text-[10px] uppercase tracking-[0.22em] text-white/70">Rejeitadas</p>
              <p className="text-lg font-semibold text-white">{rejected}</p>
            </div>
            <div className="rounded-xl border border-white/15 bg-white/10 px-3 py-2">
              <p className="text-[10px] uppercase tracking-[0.22em] text-white/70">Dias</p>
        ...
        <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
          <div className="max-w-4xl space-y-4">
            <div className="flex flex-wrap items-center gap-2">
              <Badge className="border-white/15 bg-white/10 text-white">Vacation Approval Desk</Badge>
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-3xl text-sm leading-6 text-white/78 sm:text-base">
                Filtre por colaborador e status, valide o período solicitado e aplique a decisão em
                lote com impacto explícito em dias e registros.
              </p>
            </div>
          </div>
          ...
          <div className="grid w-full max-w-md grid-cols-3 gap-3 xl:w-[420px]">
            ...
            <Stat label="Aprovadas" value={approved} hint="decisão positiva" />
            <Stat label="Rejeitadas" value={rejected} hint="decisão negativa" />
          </div>
        </div>
...
export default VacationApprovalHero;
