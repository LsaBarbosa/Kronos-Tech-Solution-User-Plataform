...
export type CreateCollaboratorResponsiveMode = "desktop" | "mobile";

const getInitialMode = (): CreateCollaboratorResponsiveMode => {
...
export const useCreateCollaboratorResponsiveMode = () => {
  const [mode, setMode] = useState<CreateCollaboratorResponsiveMode>(getInitialMode);
