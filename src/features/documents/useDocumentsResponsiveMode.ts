...
export type DocumentsResponsiveMode = "desktop" | "mobile";

const getInitialMode = (): DocumentsResponsiveMode => {
...
export const useDocumentsResponsiveMode = () => {
  const [mode, setMode] = useState<DocumentsResponsiveMode>(getInitialMode);
