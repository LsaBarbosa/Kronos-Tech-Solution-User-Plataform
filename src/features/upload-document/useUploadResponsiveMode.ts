...
export type UploadResponsiveMode = "desktop" | "mobile";

const getInitialMode = (): UploadResponsiveMode => {
...
export const useUploadResponsiveMode = () => {
  const [mode, setMode] = useState<UploadResponsiveMode>(getInitialMode);
